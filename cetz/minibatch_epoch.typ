...
#cetz.canvas({
  ...
  content((-.5, y-data + sz / 2), [Data], anchor: "east")
  line((mid, y-data - .15), (mid, .85),
    mark: (end: ">", fill: purple), stroke: purple + 1pt)
  content((mid + .2, 1.4),
    text(size: 9pt, fill: purple)[shuffle + split into mini-batches ($m = #m$)],
    anchor: "west")
  ...
  content((mid + .2, -2.05), text(size: 9pt, fill: purple)[new shuffle], anchor: "west")
})
