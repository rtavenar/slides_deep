...
\begin{tikzpicture}[
  ...
  \node[align=center, font=\footnotesize] at (0,4.20) {Entrée\\$\mathbf{x}$};
  \node[align=center, font=\footnotesize] at (1,4.20) {Caché 1\\$\mathbf{h^{(1)}}$};
  \node[align=center, font=\footnotesize] at (2,4.20) {Caché 2\\$\mathbf{h^{(2)}}$};
  \node[align=center, font=\footnotesize] at (3,4.20) {Sortie\\$\mathbf{\hat{y}}$};
