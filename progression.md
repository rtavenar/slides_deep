# Progression des séances (CM + TP)

12 séances de 2h chacune + une séance bonus pour les soutenances de lecture d'articles.
...
- [x] ResNets et autres variantes (CM) + ResNets avec torch (TP)
- [x] Projet ConvNets (TP)
